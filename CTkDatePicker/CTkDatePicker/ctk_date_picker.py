...
class CTkDatePicker(ctk.CTkFrame):
    def __init__(self, master=None, 
        ...
        super().__init__(master,width=width, height=height, bg_color=bg_color, fg_color=fg_color, **kwargs)

        self.date_entry = ctk.CTkEntry(self, width=width, height=height,placeholder_text="Select Date -> ",justify="center", bg_color=bg_color, fg_color=fg_color,font=("Palatino Linotype", 20))
        self.date_entry.grid(row=0, column=0, sticky="ew", padx=5, pady=5)
        
        self.calendar_button = ctk.CTkButton(self, text="▼", width=50, height=height,font=("Palatino Linotype", 20),command=self.open_calendar)
